...
$module->version   = 2013070201;               // If version == 0 then module will not be installed
$module->requires  = 2010112400;      // Requires this Moodle version
$module->cron      = 0;               // Period for cron to check this module (secs)
$module->component = 'mod_wiziq'; // To check on upgrade, that module sits in correct place
